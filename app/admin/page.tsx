...
export default function AdminPage() {
  ...
  // Nouveaux états pour la création de juge
  ...
  // Vue détaillée d'une image qui fait débat
  if (showDebateImage) {
    return (
  ...
  // Fonction pour créer un nouveau juge
  const handleCreateJudge = async () => {
    ...
    try {
      ...
      // Recharger les données pour voir le nouveau juge
  ...
  return (
    <div className="min-h-screen bg-black text-white pb-20">
      ...
      <main className="px-4 py-6 space-y-6">
        ...
        {/* Activité par juge avec bouton Créer */}
        <section>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 max-w-md w-full shadow-2xl">
            ...
            <input
              ...
              onKeyDown={(e) => e.key === 'Enter' && handleCreateJudge()}
              placeholder="Nom du juge"
              className="w-full p-3 bg-zinc-800 border border-zinc-700 rounded-lg text-white placeholder-zinc-500 mb-4 focus:outline-none focus:border-pink-500 transition-colors"
              autoFocus
            />
